...
for dataset in datasets:
    for set in sets:
        print(dataset, set)
        data_jpt = np.load('./Output_skeletons_without_missing_skeletons/{}/{}_data_joint_filtered.npy'.format(dataset, set))
        print(len(data_jpt))
        data_bone = np.load('./Output_skeletons_without_missing_skeletons/{}/{}_data_bones.npy'.format(dataset, set))
        print(len(data_bone))
